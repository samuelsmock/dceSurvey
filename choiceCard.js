    ...
    // Image URLS
    var imgURLs = ['/upload/surveys/996739/images/Screen%20Shot%202023-10-17%20at%2012.21.18%20PM.png', 
        ...
        for (const key in csaOptions[csa]) {
            ...
            if (key === 'priceFactor'){
                ...
                if (key){   
                    ...
                    imgElement.src = (csaOptions[csa][key] === true) ? imgURLs[1]: imgURLs[0];
